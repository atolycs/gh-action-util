...
import type { GetTokenError, GetTokenParams, GetTokenPayload } from "../types/genToken.d.ts"
...
export async function assumeRole(params: GetTokenParams) {
  ...
  const result = await client.postJson<GetTokenError>(params.providerEndpoint, payload, headers)
